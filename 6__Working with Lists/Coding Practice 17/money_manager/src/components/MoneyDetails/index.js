    ...
    return (
        <div className='money-details-container'>
            ...
            <div className='income-container'>
                <img src='https://assets.ccbp.in/frontend/react-js/money-manager/income-image.png' alt='income' className='details-img' />
                <div>
            ...
            <div className='expenses-container'>
                <img src='https://assets.ccbp.in/frontend/react-js/money-manager/expenses-image.png' alt='expenses' className='details-img' />
                <div>
