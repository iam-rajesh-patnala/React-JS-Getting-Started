...
const searchIconUrl = 'https://assets.ccbp.in/frontend/react-js/app-store/app-store-search-img.png'
...
class AppStore extends Component{
  ...
  getSearchResults = () => {
    ...
    const searchResults = appsList.filter(eachApp => eachApp.appName.toLowerCase().includes(searchInput.toLowerCase()))
      ...
      <div className='bg-container'>
        <div className='app-store'>
          ...
          <div className='search-bar-container'>
            <input type='search' className='search-input' placeholder='Search' onChange={this.onChangeSearchInput} value={searchInput}/>
